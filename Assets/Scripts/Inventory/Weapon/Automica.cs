...
public class Automica : IWeapon
{
    ...
    public override void Fire()
    {
        base.Fire();
        muzzleParicle.Play();
        MusicManager.Instance.PlaySound("Automica");
    }
