...
public class LaserBullet : MonoBehaviour
{
    ...
    private void OnCollisionEnter(Collision collision)
    {
        ...
        {
            GameObject Explode = PoolManager.gameObject.GetObjectFormPool("LaserExplode");
            if (Explode == null)
            {
            ...
            MusicManager.Instance.PlaySound("LaserExplode");
            ...
            PoolManager.gameObject.PutObjectInPool("LaserBullet", gameObject);
        }
    }
}
